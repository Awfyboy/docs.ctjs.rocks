...
Enables caching on this tileset, freezing it and turning it into a series of bitmap textures. This provides great speed boost, but prevents further editing.
